...
WorkerScript.onMessage = function (message) {
    ...
    __db.transaction(
        function(tx) {
                 try { var rs = tx.executeSql("SELECT lineIdLong, lineIdShort, lineName, lineStart, lineEnd, Lines.lineType, favorite, LineTypes.lineTypeName FROM Lines OUTER LEFT JOIN LineTypes on Lines.lineType=LineTypes.lineType " +
                                              (message.linesShowAll == "false" ? "WHERE favorite=\"true\" " : ""  ) +
